...
import de.jmmo.data.impl.MongoPointerImpl;
import de.osrg.base.util.Assert;
import dev.morphia.annotations.Id;

public class PointerFactory {

  private static final String POINTER_IMPL = "de.jmmo.data.impl.PointerImpl";
  private static final String MONGO_POINTER_IMPL = "de.jmmo.data.impl.MongoPointerImpl";
