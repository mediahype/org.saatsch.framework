...
/**
 * contains metadata for an image. The actual image has to be loaded via the ImageService.
 * 
 * @author saatsch
 *
 */
...
@BeanDefinition
public class JmmoImage extends MongoDataObject implements Bean { 
  ...
  private String filename;
    ...
    //------------------------- AUTOGENERATED START -------------------------
    /**
     * The meta-bean for {@code JmmoImage}.
     * @return the meta-bean, not null
     */
    public static JmmoImage.Meta meta() {
        return JmmoImage.Meta.INSTANCE;
    }

    static {
        MetaBean.register(JmmoImage.Meta.INSTANCE);
    }

    @Override
    public JmmoImage.Meta metaBean() {
        return JmmoImage.Meta.INSTANCE;
    }
    ...
    public static class Meta extends DirectMetaBean {
        ...
        private final MetaProperty<String> filename = DirectMetaProperty.ofReadWrite(
                this, "filename", JmmoImage.class, String.class);
        /**
         * The meta-properties.
         */
        ...
        @Override
        public BeanBuilder<? extends JmmoImage> builder() {
            return new DirectBeanBuilder<>(new JmmoImage());
        }

        @Override
        public Class<? extends JmmoImage> beanType() {
            return JmmoImage.class;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                case -734768633:  // filename
                    return ((JmmoImage) bean).getFilename();
            }
        ...
        protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
            switch (propertyName.hashCode()) {
                case -734768633:  // filename
                    ((JmmoImage) bean).setFilename((String) newValue);
                    return;
            }
