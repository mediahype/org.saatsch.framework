...
import org.saatsch.framework.jmmo.data.annotations.runtime.DepthDeleteStop;
...
public class DepthDeleter extends AbstractBeanVisitor {
  ...
  protected boolean concreteVisit(Bean bean) {
    ...
    for (String propertyName : bean.propertyNames()) {
      ...
      if (!PropertyUtil.isPropertyAnnotatedWith(property, DepthDeleteStop.class) && PropertyUtil
          .isSupportedCollection(property)
          && Bean.class.isAssignableFrom(PropertyUtil.firstTypeArg(property.metaProperty()))) {
  ...
  private boolean isMongoReferencedBean(Property<Object> property) {
    return PropertyUtil.isPropertyAnnotatedWith(property, Reference.class) && PropertyUtil.isBean(property);
  }
  ...
  private boolean isDepthDeleteCandidate(Property<Object> property) {
    return isMongoReferencedBean(property)
        && !PropertyUtil.isPropertyAnnotatedWith(property, DepthDeleteStop.class);
  }
