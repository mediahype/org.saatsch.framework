...
/**
 * Represents an internationalizable String. One instance of this class holds all available
 * translations for a String. Unique index is it's {@link #coordinate}.
 * 
 * @author saatsch
 *
 */
...
public class IntlString extends MongoDataObject implements Bean {
  ...
  /**
   * returns this IntlString's translation for a given language. Returns the first available
   * translation, if there is no translation for the given language.
   * 
  ...
  public void setForLanguage(String lang, String content) {

    strings.put(lang, content);
