...
/**
 * a comprehensive Drag And Drop Example.
 * Found at https://www.java-forums.org/swt-tips/9876-swt-dnd-drag-drop-comprehensive-example.html
 *
 */
      ...
      public void dragStart(org.eclipse.swt.dnd.DragSourceEvent event) {
        ...
        case CANVAS: {
          String[] strings = (String[]) dragControl
              .getData("STRINGS");
          if (strings == null || strings.length == 0) {            event.doit = false;
          } else {
            StringBuffer buffer = new StringBuffer();
  ...
  private void createDropTypes(Composite parent) {
    ...
    b.addSelectionListener(new SelectionAdapter() {
      public void widgetSelected(SelectionEvent e) {
        Button b = (Button) e.widget;
        if (b.getSelection()) {
          addDropTransfer(RTFTransfer.getInstance());        } else {
